...
# set MECH      = cb6r3_ae7_aq      #> Mechanism ID
 set APPL      = MACS12_2019_Feb20_DEBUG  #> Application Name (e.g. Gridname)
...
#> AP: deposition mode and debug set manually below as don't have config parameters for these: 
 set BLD       = ${CMAQ_HOME}/CCTM/builds/BLD_CCTM_${VRSN}_${compilerString}_${MECH}_m3dry_debug
...
#> Set Start and End Days for looping
 ...
 set START_DATE = "2019-02-20"     #> beginning date 
 set END_DATE   = "2019-02-21"     #> ending date  
...
#> Output Species and Layer Options
   ...
   #> A file species; comment or set to "ALL" to write all species to ACONC
...
#  setenv MISC_CTRL_NML ${BLD}/CMAQ_Control_Misc_reduced_aelmo_output_2025-11-06.nml
  ...
  setenv CMAQ_MASKS OCEAN_${MM}_L3m_MC_CHL_chlor_a_MACS12_complete.nc 
  #> horizontal grid-dependent ocean file
...
#  setenv STK_EMIS_LAB_010 PT_CMV_C1C2
 ...
 # setenv STK_EM_SYM_DATE_008 F
  ...
  setenv OCEAN_1 $SZpath/OCEAN_${MM}_L3m_MC_CHL_chlor_a_MACS12_complete.nc #> horizontal grid-dependent ocean file
  #setenv OCEAN_1   $SZpath/ocean_01_AEP_MACS_12km-updated.ncf
...
# set NPMAX    =  6  # Number of sensitivity parameters defined in SEN_INPUT
# setenv SEN_INPUT ${WORKDIR}/sensinput.2018_MACS_sl
set NPMAX    =  3
setenv SEN_INPUT ${WORKDIR}/sensinput.2018_MACS.dat
#run_cctm_2018_12US1_v54+_cb6r5_ae6.20171222_2.csh
 setenv DDM3D_HIGH Y  # allow higher-order sensitivity parameters in SEN_INPUT [ T | Y | F | N ] (default is N/F)
