...
# set MECH      = cb6r3_ae7_aq      #> Mechanism ID
 set APPL      = Bench_MACS_2019_Mar_4_5_test  #> Application Name (e.g. Gridname)
...
#> Set Start and End Days for looping
 ...
 set START_DATE = "2019-03-04"     #> beginning date (Mar 1, 2019)
 set END_DATE   = "2019-03-05"     #> ending date    (May 31, 2019)
