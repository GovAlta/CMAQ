...
#> is located by default).
 set BLD       = ${CMAQ_HOME}/CCTM/builds/BLD_CCTM_${VRSN}_${compilerString}_${MECH}_${DEP}_debug
...
#> Set Working, Input, and Output Directories
 ...
 setenv OUTDIR  ${CMAQ_DATA}/2018_12NE3/bwz  #> Output Directory
